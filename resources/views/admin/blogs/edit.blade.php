...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="feature_image">{{ trans('cruds.blog.fields.feature_image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.blog.fields.feature_image_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($blog) && $blog->feature_image)
      var file = {!! json_encode($blog->feature_image) !!}
