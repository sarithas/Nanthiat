<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('project_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/project-details*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('project_detail_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.project-details.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/project-details") || request()->is("admin/project-details/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('gallery_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/photos*") ? "c-show" : "" }} {{ request()->is("admin/videos*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
